...
public final class WTHITDataProvider implements IWailaPlugin, IBlockComponentProvider, IEntityComponentProvider, IEventListener {
	...
	public void appendHead(ITooltip tooltip, IBlockAccessor data, IPluginConfig config) {
		...
		if (displayStack != null)
			tooltip.setLine(WailaConstants.OBJECT_NAME_TAG, new TranslatableComponent(displayStack.getDescriptionId()).setStyle(ITEM_NAME_STYLE));
	}
	...
	public void appendTail(ITooltip tooltip, IBlockAccessor accessor, IPluginConfig config) {
		...
		if (disguisedAs != null)
			tooltip.setLine(WailaConstants.MOD_NAME_TAG, new TextComponent(ModList.get().getModContainerById(disguisedAs.getItem().getRegistryName().getNamespace()).get().getModInfo().getDisplayName()).setStyle(MOD_NAME_STYLE));
	}
